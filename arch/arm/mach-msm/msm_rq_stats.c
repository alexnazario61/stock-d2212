...
//<2014/09/24-44328-ChengOuYang,[All][Main][kernel][DMS05855775] reduce the showing time for the black screen
	this_cpu->cur_freq = cpufreq_quick_get(cpu);
//	this_cpu->cur_freq = acpuclk_get_rate(cpu);
//>2014/09/24-43328-ChengOuYang
