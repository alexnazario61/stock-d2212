...
/*[Arima5908][44725][Raymond_lin] Apply QCT patch to fix HWWD crash issue -20141009 begin*/
	struct ion_handle *cmnlib_ion_handle;
/*[Arima5908][44725][Raymond_lin] Apply QCT patch to fix HWWD crash issue -20141009 end*/
