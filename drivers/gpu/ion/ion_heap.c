...
//[CAMERA][kent][36801][01Begin]Qualcomm SR:01519854 fix that the preview image was freeze by mWindow->dequeue_buffer function			
	#if 0
 ...
 * any moment. 
*/ 
//[CAMERA][kent][36801][01end]Qualcomm SR:01519854 fix that the preview image was freeze by mWindow->dequeue_buffer function
...
//[CAMERA][kent][36801][02Begin]Qualcomm SR:01519854 fix that the preview image was freeze by mWindow->dequeue_buffer function
	  memset(ptr, 0, npages_to_vmap * PAGE_SIZE); 
//[CAMERA][kent][36801][02End]Qualcomm SR:01519854 fix that the preview image was freeze by mWindow->dequeue_buffer function
		vunmap(ptr);
	}
